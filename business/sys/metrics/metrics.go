...
// Unexported which means it will never be constructed outside of this project
type metrics struct {
...
// AddErrors increments thr errors metric by 1.
...
// AddPanics increments thr errors metric by 1.
